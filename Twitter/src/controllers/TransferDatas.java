...
public class TransferDatas {
	...
	public TransferDatas() {
		this.tweetList = new ArrayList<Tweet>();
		this.initialiseTweetList("datas/tweetsdatabase.csv");
		this.destFile = new File("datas/tweetreference.csv");
		
	}
	
	/**
	 * we save the tweets from the tweetsdatabase.csv to tweetreference.csv
	 */
	public void transfer() {
		this.checker = new DuplicationChecker("datas/tweetreference.csv"); 
		FileWriter writer;
